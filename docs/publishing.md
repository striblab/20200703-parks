...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20181107-sheriff-map">Loading...</div>
...
1.  Create an LCD that is connected to the Article.
    ...
    * Common values in the LCD to use:
      ...
      * `styles`: `news/projects/all/20181107-sheriff-map/styles.bundle.css`
      * `scripts`: `news/projects/all/20181107-sheriff-map/app.bundle.js`
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20181107-sheriff-map/",
      "url": "http://static.startribune.com/news/projects-staging/all/20181107-sheriff-map/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20181107-sheriff-map/",
      "url": "http://static.startribune.com/news/projects/all/20181107-sheriff-map/"
    }
  }
}
```
